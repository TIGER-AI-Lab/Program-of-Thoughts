...
if __name__ == "__main__":
    ...
    if args.greedy:
        filename = f'outputs/convfinqa_direct_s{args.start}_e{args.end}_{dt_string}.jsonl'
    else:
        filename = f'outputs/convfinqa_direct_sc_s{args.start}_e{args.end}_{dt_string}.jsonl'
    ...
    for example in tqdm(convfinqa_dev):
        ...
        if prediction is None:
            ...
            wrong += 1
        print(f'prediction: {prediction}, answer: {example["answer"]}')
