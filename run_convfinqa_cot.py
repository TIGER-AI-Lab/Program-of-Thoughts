...
if __name__ == "__main__":
    ...
    if args.greedy:
        filename = f'outputs/convfinqa_cot_s{args.start}_e{args.end}_{dt_string}.jsonl'
    else:
        filename = f'outputs/convfinqa_cot_sc_s{args.start}_e{args.end}_{dt_string}.jsonl'
