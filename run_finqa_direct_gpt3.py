...
if __name__ == "__main__":
    ...
    if args.greedy:
        filename = f'outputs/finqa_direct_gpt3_s{args.start}_e{args.end}_{dt_string}.jsonl'
    else:
        filename = f'outputs/finqa_direct_gpt3_sc_s{args.start}_e{args.end}_{dt_string}.jsonl'
